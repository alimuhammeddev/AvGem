    ...
    return (
        <section>
            ...
            <div className='max-w-7xl mx-auto lg:mt-28 mt-20'>
                <h1 className='lg:text-lg text-[#97877A] lg:p-0 p-5'>Home  Raw Gemstones – Ethically Sourced Raw Diamonds & Gemstones</h1>
                ...
                <div className='lg:flex lg:items-start lg:mt-10 justify-between lg:gap-28'>
                    ...
                    <div>
                        <div className='lg:p-0 p-5'>
                            <h1 className='text-[#333333] lg:text-3xl text-2xl font-semibold text-center'>Raw Diamonds / Rough Diamonds</h1>
                        <p className='text-[#333333] lg:text-xl font-semibold text-center'>Raw and Natural Stone Collections</p>
                        ...
                        <div className='flex items-center justify-between mt-5 lg:mt-10'>
                            <h1 className='text-[#97877A] lg:text-lg'>48 products</h1>
